...
base.BakToFolder = 'bak'  # Relative path, None = does not make a copy of file
...
ftp.BakToFolder = 'bak/ftp'  # Relative path, None = does not make a copy of file
...
dropbox.BakToFolder = 'bak/dropbox'  # Relative path, None = does not make a copy of file
